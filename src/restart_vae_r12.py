...
class VariationalEncoder(nn.Module):
    def __init__(self, latent_dims):
        ...
        self.conv2_3 = nn.Conv2d(16, 16, 3, stride=1, padding='same')
        self.batch2_3 = nn.BatchNorm2d(16)
        ...
        self.conv3_3 = nn.Conv2d(32, 32, 3, stride=1, padding='same')
        self.batch3_3 = nn.BatchNorm2d(32)
        ...
        self.linear1_3 = nn.Linear(64, 16)
    ...
    def forward(self, x):
        ...
        x1 = F.relu(self.batch2(self.conv2(x)))
        x = F.relu(self.batch2_2(self.conv2_2(x1)))
        x = F.relu(self.batch2_3(self.conv2_3(x)))
        x = x + x1
        
        x2 = F.relu(self.batch3(self.conv3(x)))
        x = F.relu(self.batch3_2(self.conv3_2(x2)))
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(vae.state_dict(), 'models/restart_vae_addSpots_r12.pt')
...
# plot predictions
# vae.load_state_dict(torch.load('models/restart_vae_addSpots_r12.pt', map_location = torch.device('cpu')))
