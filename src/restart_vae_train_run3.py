...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(vae.state_dict(), 'models/restart_vae_addSpots_run3.pt')
...
# plot predictions
# vae.load_state_dict(torch.load('models/restart_vae_addSpots_run3.pt', map_location = torch.device('cpu')))
# vae.eval()
