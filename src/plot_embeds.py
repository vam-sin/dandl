...
# import data annots
ds_patches = pd.read_csv('gen_files/patches_csv_receptor.csv')
...
embeds_vae = np.load('gen_files/embeds_vae_receptor_fromReceptorTrain_run7.npz', allow_pickle = True)['arr_0']
...
plt.title('UMAP of VAE-BGReceptor_r7 on Receptor Test', fontsize=20)
plt.show()
