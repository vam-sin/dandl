...
#         torch.save(vae.state_dict(), 'models/restart_vae_addSpots_r10.pt')
...
# plot predictions
vae.load_state_dict(torch.load('models/restart_vae_addSpots_r10.pt', map_location = torch.device('cpu')))
vae.eval()
