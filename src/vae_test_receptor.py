...
vae.load_state_dict(torch.load('vae_receptor_run6.pt'))
vae.eval()
...
# patches_csv.to_csv('patches_csv_receptor_4.csv')
np.savez_compressed('embeds_vae_receptor_fromReceptorTrain_run6.npz', embeds_vae)
print(patches_csv)
