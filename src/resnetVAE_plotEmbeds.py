...
# import data annots
ds_patches = pd.read_csv('gen_files/patches_csv_bg_addSpots_32__O1.csv')
...
embeds_vae = np.load('gen_files/embeds_resnetVAE_BG_run2__O1.npz', allow_pickle = True)['arr_0']
...
plt.title('UMAP of ResNetVAE-BGSynth_run2', fontsize=20)
plt.show()
