...
#         torch.save(vae.state_dict(), 'models/restart_vae_addSpots_run2.pt')
...
# plot predictions
vae.load_state_dict(torch.load('models/restart_vae_addSpots_run2.pt', map_location = torch.device('cpu')))
vae.eval()
