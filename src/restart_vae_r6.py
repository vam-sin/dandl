...
class VariationalEncoder(nn.Module):
    def __init__(self, latent_dims):
        ...
        self.linear1_2 = nn.Linear(64, 16)
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(vae.state_dict(), 'models/restart_vae_addSpots_r6.pt')
...
# plot predictions
# vae.load_state_dict(torch.load('models/restart_vae_addSpots_r6.pt', map_location = torch.device('cpu')))
# vae.eval()
